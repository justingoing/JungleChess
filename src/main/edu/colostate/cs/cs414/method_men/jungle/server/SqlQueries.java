...
public interface SqlQueries {
     ...
     * @return ID: Integer unique to match_state row
     */
    @SqlUpdate("INSERT INTO match_state(User1,User2,State,Start_Date) values(:input,:input2,:input3,:input4);")
    @GetGeneratedKeys("ID")
    Integer addMatchState(@Bind("input") String input, @Bind("input2")String input2, @Bind("input3") String input3, @Bind("input4")String input4);
     ...
     * @return ID: Integer unique to match_record row
     */
    @SqlUpdate("INSERT INTO match_record(Winner,Loser,Game_Start,Game_End) values(:input,:input2,:input3,:input4);")
    @GetGeneratedKeys("ID")
    Integer addMatchRecord(@Bind("input") String input, @Bind("input2")String input2, @Bind("input3") String input3, @Bind("input4")String input4);
